import React from 'react'
    ...
    const $American_Society_of_Consultant_Pharmacists_Student_Chapter__Orlando_Page = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
                <h1 className="text-4xl font-bold text-center text-slate-700 mb-4">
                    American Society of Consultant Pharmacists-Student Chapter (Orlando)
                </h1>
    ...
    export default  $American_Society_of_Consultant_Pharmacists_Student_Chapter__Orlando_Page;
