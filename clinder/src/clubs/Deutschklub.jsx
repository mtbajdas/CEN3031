import React from 'react'
    ...
    const $DeutschklubPage = () =>{
        ...
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                Deutschklub is established for the purpose of creating an open and friendly environment that promotes, develops and celebrates German language and culture on campus.
            </p>
    ...
    export default  $DeutschklubPage;
