import React from 'react'
    ...
    const $Chinese_Student_AssociationPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                serve both students and faculty with Chinese ethnics and UF students who are interested in Chinese language and culture
            </p>
    ...
    export default  $Chinese_Student_AssociationPage;
