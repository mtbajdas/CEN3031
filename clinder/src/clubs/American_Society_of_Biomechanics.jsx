import React from 'react'
    ...
    const $American_Society_of_BiomechanicsPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                The purpose of the American Society of Biomechanics chapter is to foster the advancement, communication, and application of biomechanics to benefit society.
            </p>
    ...
    export default  $American_Society_of_BiomechanicsPage;
