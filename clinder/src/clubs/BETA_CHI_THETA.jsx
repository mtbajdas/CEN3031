import React from 'react'
    ...
    const $BETA_CHI_THETAPage = () =>{
        ...
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                The purpose of Beta Theta is to assemble motivated young men to uphold the six founding pillars by which it stands
            </p>
    ...
    export default  $BETA_CHI_THETAPage;
