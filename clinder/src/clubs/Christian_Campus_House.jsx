import React from 'react'
    ...
    const $Christian_Campus_HousePage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                CCH is all about family, making disciples, and worldwide impact! We invite you to come see how we do life together.
            </p>
    ...
    export default  $Christian_Campus_HousePage;
