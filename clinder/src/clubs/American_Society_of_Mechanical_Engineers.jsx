import React from 'react'
    ...
    const $American_Society_of_Mechanical_EngineersPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                Prepare students for a career in engineering through professional development and hands-on experience.
            </p>
    ...
    export default  $American_Society_of_Mechanical_EngineersPage;
