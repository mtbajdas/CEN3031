import React from 'react'
    ...
    const $Alagarto_Printmaking_GuildPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                Our purpose is to help promote and spread the ideas and processes of printmaking.
            </p>
    ...
    export default  $Alagarto_Printmaking_GuildPage;
