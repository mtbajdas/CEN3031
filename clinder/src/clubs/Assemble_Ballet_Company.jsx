import React from 'react'
    ...
    const $Assemble_Ballet_CompanyPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                Assemblé Ballet Company is a student-run organization focused on improving ballet strength and technique. No audition or dress code required. All levels welcome. Come check us out!
            </p>
    ...
    export default  $Assemble_Ballet_CompanyPage;
