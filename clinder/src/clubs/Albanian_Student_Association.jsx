import React from 'react'
    ...
    const $Albanian_Student_AssociationPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                To promote awareness about the history, culture, and traditions of the beautiful country of Albania.
            </p>
    ...
    export default  $Albanian_Student_AssociationPage;
