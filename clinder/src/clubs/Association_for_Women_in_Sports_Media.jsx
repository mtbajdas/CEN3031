import React from 'react'
    ...
    const $Association_for_Women_in_Sports_MediaPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                The purpose of the Association for Women in Sports Media is to support the advancement and growth of women in sports media. The organization seeks to provide career-enhancing networking and mentorship opportunities.
            </p>
    ...
    export default  $Association_for_Women_in_Sports_MediaPage;
