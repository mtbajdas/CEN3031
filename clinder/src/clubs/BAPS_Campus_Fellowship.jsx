import React from 'react'
    ...
    const $BAPS_Campus_FellowshipPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                The purpose of the organization shall be to unite students on University of Florida’s campus and provide opportunities to learn about Hindu heritage and culture.
            </p>
    ...
    export default  $BAPS_Campus_FellowshipPage;
