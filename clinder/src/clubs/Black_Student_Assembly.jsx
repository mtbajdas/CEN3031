import React from 'react'
    ...
    const $Black_Student_AssemblyPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                The purpose of the Black Student Assembly is to promote and highlight the culture of black excellence here at the University of Florida.
            </p>
    ...
    export default  $Black_Student_AssemblyPage;
