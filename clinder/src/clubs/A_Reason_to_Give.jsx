import React from 'react'
    ...
    const $A_Reason_to_GivePage = () =>{
        ...
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                Our goal is to help serve the homeless population in Gainesville by providing weekly lunches!
            </p>
    ...
    export default  $A_Reason_to_GivePage;
