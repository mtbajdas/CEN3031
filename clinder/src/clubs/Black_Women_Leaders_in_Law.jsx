import React from 'react'
    ...
    const $Black_Women_Leaders_in_LawPage = () =>{
        return(
    ...
    export default  $Black_Women_Leaders_in_LawPage;
