import React from 'react'
    ...
    const $American_Institute_of_Architecture_StudentsPage = () =>{
        return(
    ...
    export default  $American_Institute_of_Architecture_StudentsPage;
