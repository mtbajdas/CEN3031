import React from 'react'
    ...
    const $American_Constitution_Society_for_Law_and_PolicyPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                To promote a living Constitution.
            </p>
    ...
    export default  $American_Constitution_Society_for_Law_and_PolicyPage;
