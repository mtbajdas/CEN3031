import React from 'react'
    ...
    const $Alpha_Kappa_DeltaPage = () =>{
        ...
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                We promote excellence in the study of sociology, research of social problems, and other social and intellectual activities that will lead to improvement in the human condition.
            </p>
    ...
    export default  $Alpha_Kappa_DeltaPage;
