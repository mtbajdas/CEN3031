import React from 'react'
    ...
    const $Brazilian_Student_AssociationPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                To empower and engage students that empathize with the Brazilian culture and traditions through service, academic, and social events.
            </p>
    ...
    export default  $Brazilian_Student_AssociationPage;
