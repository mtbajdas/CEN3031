import React from 'react'
    ...
    const $Agricultural_and_Life_Sciences_College_CouncilPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                Provide leadership for CALS students and student organizations.
            </p>
    ...
    export default  $Agricultural_and_Life_Sciences_College_CouncilPage;
