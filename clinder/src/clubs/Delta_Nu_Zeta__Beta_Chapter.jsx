import React from 'react'
    ...
    const $Delta_Nu_Zeta__Beta_ChapterPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                Delta Nu Zeta functions as a social and service-oriented sorority that strives to bring out the best in its members and to promote the welfare of the community.
            </p>
    ...
    export default  $Delta_Nu_Zeta__Beta_ChapterPage;
