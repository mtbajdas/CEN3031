import React from 'react'
    ...
    const $Christians_On_CampusPage = () =>{
        return(
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 text-center leading-relaxed">
                The purpose of Christians on Campus is to study the Bible, promote Christian fellowship, and spread the Gospel of Jesus Christ to interested students.
            </p>
    ...
    export default  $Christians_On_CampusPage;
